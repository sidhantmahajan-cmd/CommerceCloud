...
{
	private static final String PASSWORD_AUTHORIZATION_SCOPE = "sncustomwebservices.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "sncustomwebservices.oauth2.clientCredentials.scope";
	private static final String AUTHORIZATION_URL = "sncustomwebservices.oauth2.tokenUrl";

	private static final String DESC = "sncustomwebservices.v2.description";
	private static final String TITLE = "sncustomwebservices.v2.title";
	private static final String VERSION = "sncustomwebservices.v2.version";
	private static final String LICENSE = "sncustomwebservices.v2.license";
	private static final String LICENSE_URL = "sncustomwebservices.v2.license.url";
