...
import com.sncustomwebservices.product.data.PromotionResultDataList;
...
import com.sncustomwebservices.voucher.data.VoucherDataList;
...
public class CartsController extends BaseCommerceController
{
	...
	@ApiBaseSiteIdUserIdAndCartIdParam
	public CartModificationWsDTO addToCartEntryGroup(
			@PathVariable final String baseSiteId,
